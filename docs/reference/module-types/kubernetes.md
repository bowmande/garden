...
# Specifies necessary configuration details of the local application which will replace a target remote service in the
# k8s cluster.
#
...
### `localMode.localAppPort`

[localMode](#localmode) > localAppPort
